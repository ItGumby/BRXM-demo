...
@HippoEssentialsGenerated(internalName = "brxm15.2.2:account")
@Node(jcrType = "brxm15.2.2:account")
public class Account extends HippoCompound {

    public static final String TYPE = "brxm15.2.2:type";
    public static final String LINK = "brxm15.2.2:link";

    @HippoEssentialsGenerated(internalName = "brxm15.2.2:type")
